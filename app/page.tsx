    ...
    <section className="space-y-10">
      <div className="overflow-hidden rounded-2xl border border-[#29204E] bg-[linear-gradient(135deg,#050713_0%,#10172F_48%,#2B185F_100%)] text-white shadow-2xl">
        <div className="grid gap-10 p-6 md:p-10 lg:grid-cols-[1.05fr_0.95fr] lg:p-14">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="mt-7 max-w-3xl text-5xl font-extrabold leading-[0.95] tracking-tight md:text-7xl">
              Stop losing profit to dead inventory.
            </h1>
            <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-slate-300">
              ResaleIQ is not a listing generator. It is a margin protection and decision engine that tells resellers what to recover, reprice, crosslist, bundle, hold, or liquidate.
            </p>
            <div className="mt-9 flex flex-wrap gap-4">
              <a href="/dead-listings" className="rounded-2xl bg-[#7C5CFF] px-6 py-3 font-extrabold text-white shadow-lg shadow-[#7C5CFF]/25 hover:bg-[#6A48EA]">
                Find Dead Inventory
              </a>
          ...
          <div className="rounded-2xl border border-white/10 bg-[#11172E]/95 p-5 shadow-2xl">
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-bold">Recovery Dashboard</p>
                <p className="text-xs text-slate-400">Live MVP sample inventory</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="rounded-2xl bg-[#1A223F] p-4">
                <p className="text-xs font-bold uppercase tracking-[0.14em] text-slate-400">Dead Alerts</p>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-tan bg-white p-6 shadow-sm">
          ...
          <h2 className="mt-3 text-2xl font-extrabold text-ink">Know what to do next.</h2>
        ...
        <div className="rounded-2xl border border-tan bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">Fees, shipping, refund reserve, weak pricing, and stale inventory risk are exposed before more time gets spent.</p>
        </div>
        <div className="rounded-2xl border border-tan bg-white p-6 shadow-sm">
      ...
      <div className="rounded-2xl border border-tan bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          ...
          <a href="/dead-listings" className="rounded-2xl bg-ink px-4 py-3 text-sm font-extrabold text-white hover:bg-[#2B185F]">Open Recovery Room</a>
        </div>
